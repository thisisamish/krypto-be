...
import com.groupeight.krypto.dto.AddressDto;
import com.groupeight.krypto.dto.CheckoutRequestDto;
import com.groupeight.krypto.dto.OrderItemDto;
...
import com.groupeight.krypto.model.Address;
...
public class CheckoutServiceImpl implements CheckoutService {
	...
	public OrderResponseDto placeOrder(Long userId, CheckoutRequestDto request) {
		...
		cart.getItems().forEach(ci -> {
			OrderItem oi = OrderItem.builder().productId(ci.getProduct().getId()).productName(ci.getProduct().getName())
